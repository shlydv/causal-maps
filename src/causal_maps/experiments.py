...
def main(stage, config=None, out_dir="/kaggle/working"):
    ...
    if stage == "delta_causal_atlas":
        ...
        log("=== done ===")
        return res
    if stage == "delta_functional_causal_rank":
        from .delta_functional_causal_rank import (
            run_delta_functional_causal_rank,
        )
        res = run_delta_functional_causal_rank(
            config["model_path"], out_dir,
            model_key=config.get(
    ...
    if stage == "delta_latent_instruction_compiler":
        ...
        log("=== done ===")
        return res
    if stage == "delta_three_mode_selector":
        from .delta_three_mode_selector import (
            run_delta_three_mode_selector,
        )
        res = run_delta_three_mode_selector(
            config["model_path"], out_dir,
            model_key=config.get(
