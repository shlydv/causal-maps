...
Status: frozen before any evaluation of the fourth fresh color set.
...
- Construct 60 color histories absent from all preceding color sets under the
  original, already behaviorally stable color prompt.
- Freeze the first 30 histories as activation-only discovery and the final 30
  as causal holdout.
